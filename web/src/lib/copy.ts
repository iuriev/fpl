...
export const copy = {
  ...
  priceChangesEmptyGwHeading: 'No price changes yet',
  priceChangesEmptyGwSubtext: 'Updates usually appear overnight (UK).',
  priceChangesEmptySeasonHeading: 'No season price movement',
  priceChangesEmptySeasonSubtext: 'Try switching the direction or position filter.',
  priceChangesEmptyTonightHeading: 'No predictions for this filter',
  priceChangesEmptyTonightSubtext: 'Try a different position or direction.',
  priceChangesEmptySquadHeading: 'None of your squad players match',
  priceChangesEmptySquadSubtext: 'Try switching to All FPL.',
  ...
  aiFreehitNoPredictions: 'AI suggestions are not available for GW {gw}',
