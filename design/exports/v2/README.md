...
| `screens.jsx` | Full screen compositions — `EntryScreen`, `SquadScreen`. Built on top of pitch.jsx + tokens. |
...
| `FPL Squad Viewer.html` | Full design sheet — every screen × state on a single design canvas. |
